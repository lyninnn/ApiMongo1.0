...
import com.example.ApiMongo.repositories.PokemonRepository;
import com.example.ApiMongo.repositories.PokemonRepositoryCustom;
...
public class PokemonService {
    ...
    public boolean register(Pokemon pokemonDTO) {
    ...
    public void updatePokemon(String id, Pokemon pokemonDTO) {
    ...
    public void patchPokemon(String id, Pokemon pokemonDTO) {
        Optional<Pokemon> pokemonOptional = pokemonRepository.findById(id);
