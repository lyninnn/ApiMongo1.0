...
import com.example.ApiMongo.services.PokemonService;
...
import java.util.Optional;
    ...
    public class PokemonCon {
        ...
        public ResponseEntity<String> registerPokemon(@RequestBody Pokemon pokemonDTO) {
        ...
        public ResponseEntity<Pokemon> updatePokemon(@PathVariable("id") String id, @RequestBody Pokemon pokemonDTO) {
            try {
        ...
        public ResponseEntity<Pokemon> patchPokemon(@PathVariable("id") String id, @RequestBody Pokemon pokemonDTO) {
            try {
