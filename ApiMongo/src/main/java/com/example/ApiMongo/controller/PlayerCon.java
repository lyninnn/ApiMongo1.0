...
import com.example.ApiMongo.services.PlayerService;
...
public class PlayerCon {
    ...
    public ResponseEntity<String> registerPlayer(@RequestBody Player playerDTO) {
    ...
    public ResponseEntity<Player> updatePlayer(@PathVariable("id") String id, @RequestBody Player playerDTO) {
        try {
    ...
    public ResponseEntity<Player> patchPlayer(@PathVariable("id") String id, @RequestBody Player playerDTO) {
        try {
